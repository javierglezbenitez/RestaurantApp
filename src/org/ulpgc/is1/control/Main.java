...
public class Main {
    private static void init(OrderManager orderManager) {
        ...
        orderManager.addRestaurant("El Rincón del Sabor", new Phone("987654321"), new Menu("Menú diario", MenuType.Daily));
    ...
    public static void main(String[] args) {
        ...
        orderManager.order(orderManager.getCustomer(0), orderManager.getRestaurant(0), new int[]{orderManager.getDishesNumber() - 1, orderManager.getDishesNumber() - 2}, new int[]{2, 1});
